              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.inventory_2_outlined, size: 72, color: Color(0xFF1D4ED8)),
                      const SizedBox(height: 12),
                      Text('eArsip Mobile', textAlign: TextAlign.center, style: Theme.of(context).textTheme.headlineMedium),
