...
class AppConfig {
  static const defaultBaseUrl = 'https://market.ias4u.my.id/api/mobile/v1';
  ...
  static Future<void> saveBaseUrl(String value) async {
    ...
    if (uri == null || uri.scheme != 'https' || uri.host.isEmpty) throw const FormatException('Alamat server harus URL HTTPS yang valid.');
    final prefs = await SharedPreferences.getInstance();
