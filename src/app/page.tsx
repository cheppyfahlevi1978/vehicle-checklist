...
export default async function Home() {
  ...
  const roles = [
    ...
    {
      href: latestSession ? `/guest/${latestSession.id}` : "/valet/checkin",
      tag: "Untuk tamu",
      title: "Guest Portal",
      desc: latestSession
        ? "Lihat laporan kondisi mobil dan riwayat inspeksi tanpa perlu instal aplikasi."
        : "Belum ada sesi — mulai dengan check-in kendaraan lewat peran Valet.",
    },
  ];
